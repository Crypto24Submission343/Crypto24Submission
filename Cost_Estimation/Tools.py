...
def get_intersections(n, max_depth, log_M, z_to_cost):
    ...
    intersections['aes_grover'] = [z_value, total_INEQ_crit, y_total_cost[z_value],]
    ...
    intersections['target'] = [z_value, total_INEQ_crit, y_total_cost[z_value],]
    #print(f"  is z_value={z_value}, ineq is {inequality} \n")
    ...
    intersections['quasi-quadratic'] = [z_value, total_INEQ_crit, y_total_cost[z_value]]
...
class CostFiles:
    ...
    """
    def __init__(self, bound_coef, modulus_q, const_reps_QPE, const_reps_W, num_nodes_branching_dfs, force_DF, bound):
        """f
...
class DataFiles(CostFiles):
    ...
    """
    def __init__(self, max_depth, n, bound_coef, modulus_q, const_reps_QPE, const_reps_W, num_nodes_branching_dfs, force_DF, bound):
        self.n = n
        self.max_depth = max_depth
        super().__init__(bound_coef, modulus_q, const_reps_QPE, const_reps_W, num_nodes_branching_dfs, force_DF, bound)
...
class ResultFiles(CostFiles):
    ...
    """
    def __init__(self, bound_coef, modulus_q, const_reps_QPE, const_reps_W, num_nodes_branching_dfs, force_DF, results_dir='costResults', bound='none'):
        """
        Parameters as used in the cost estiamtion.
        :param modulus_q: LWE modulus q
        :param bound_coef:    Bound C on the node degree used for enumeration of the tree (cf. Section 3.1).
